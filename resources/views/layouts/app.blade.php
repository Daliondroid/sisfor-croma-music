    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .nav-item {
            ...
            color:rgba(255,255,255,.75); border-left:3px solid transparent; transition:.2s;
        }
        ...
        .dropdown-header-name { font-weight:700; font-size:.9rem; }
        ...
        .form-control { width:100%; padding:10px 14px; border:1.5px solid #e5e7eb; border-radius:8px; font-size:.875rem; font-family:inherit; transition:.2s; background:#fff; }
...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-footer" style="padding:16px 24px;border-top:1px solid rgba(255,255,255,.1)">
        <div style="font-size:.65rem;color:rgba(255,255,255,.3);text-align:center">
